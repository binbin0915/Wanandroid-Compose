...
import luyao.wanandroid.compose.model.bean.*
...
interface WanService {
    ...
    fun getHomeArticles(@Path("page") page: Int): Call<WanResponse<ArticleList>>
    ...
    fun getLastedProject(@Path("page") page: Int): Call<WanResponse<ArticleList>>
    ...
    fun getSquareArticleList(@Path("page") page: Int): Call<WanResponse<ArticleList>>
